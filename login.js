...
function passValid()
{
    ...
    {
        document.body.style.backgroundImage="lineargradient(75deg,red,red)";
    ...
    {
        document.body.style.backgroundImage="linear gradient(75deg,rgb(93,0,97),red)";
    ...
    else(emailIdOrPhno==userGivenMailorNum && pass==userGivenpassword)
    {
